CREATE DATABASE IF NOT EXISTS choice_uni_db;

CREATE USER 'choice'@'%' IDENTIFIED BY 'university';
GRANT ALL PRIVILEGES ON choice_uni_db.* TO 'choice'@'%';
FLUSH PRIVILEGES;
...
CREATE TABLE position (
  ...
  position_name VARCHAR2(500) NOT NULL
);
